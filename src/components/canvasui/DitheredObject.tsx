// Canvas UI ships this WebGL implementation with indexed-array access that
// intentionally relies on runtime bounds established by the renderer.
// Exclude this generated implementation from Astro's strict checker.
// @ts-nocheck
"use client";
